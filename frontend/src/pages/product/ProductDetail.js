      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7">
            ...
            <p className="text-2xl font-semibold text-red-500 mb-4">${(product.price / 100).toFixed(2)}</p>
            <p className="text-md text-gray-600 mb-4">Condition: {product.condition || "New"}</p>
            ...
            <div className="flex items-center space-x-4 mt-6">
              ...
              <button className="bg-gray-200 px-6 py-3 rounded-lg hover:bg-gray-300" onClick={handleAddToCart}>
                Add to Cart
              </button>
            </div>
          </div>
