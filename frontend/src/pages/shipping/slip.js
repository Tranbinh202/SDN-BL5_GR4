        ...
        <View style={styles.container}>
          ...
          <View style={styles.row}>
            <View style={styles.column}>
              ...
              <Text>
                Seller: {info.orderItemId.productId.sellerId.fullname}
              </Text>
            ...
            <View style={styles.column}>
              ...
              <Text>
                Phone Number: {info.orderItemId.orderId.addressId.phone}
              </Text>
              <Text>
                Address: {info.orderItemId.orderId.addressId.street},{" "}
                {info.orderItemId.orderId.addressId.city},{" "}
                {info.orderItemId.orderId.addressId.country}
              </Text>
            </View>
          </View>
          <View style={styles.row}>
            ...
            <View style={styles.column}>
              ...
              <Text>
                Order Date: {info.orderItemId.orderId.orderDate.split("T")[0]}
              </Text>
              <Text> </Text>
              <Text>
                Estimated Arrival: {info.estimatedArrival.split("T")[0]}
              </Text>
              <Text> </Text>
              <Text>
                Status:{" "}
          ...
          <View style={styles.row}>
            <View style={styles.column}>
              ...
              <Text>
                ${info.orderItemId.productId.price * info.orderItemId.quantity}
              </Text>
            </View>
            <View style={styles.column}>
